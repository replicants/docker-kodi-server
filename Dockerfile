...
RUN cd /root/ && \
		...
		git clone https://github.com/xbmc/xbmc.git -b 16.1-Jarvis --depth=1 && \
		cd /root/xbmc && \
		mv /headless.patch . && \
		...
		apt-get purge -y autoconf automake autopoint autotools-dev binutils build-essential bzip2 bzip2-doc ca-certificates ca-certificates-java cmake cmake-data cpp cpp-5 curl dpkg-dev fakeroot g++ g++-5 gawk gcc gcc-5 geoip-database git git-man gperf icu-devtools ifupdown iproute2 isc-dhcp-client isc-dhcp-common java-common less libalgorithm-diff-perl libalgorithm-diff-xs-perl libalgorithm-merge-perl libarchive13 libasan2 libass-dev libasyncns0 libatm1 libatomic1 libavcodec-dev libavfilter-dev libavformat-dev libavresample-dev libavutil-dev libboost-dev libboost1.58-dev libbz2-dev libc-dev-bin libc6-dev libcc1-0 libcdio-dev libcdio13 libcilkrts5 libcurl3 libcurl4-gnutls-dev libdns162 libdpkg-perl libdrm-dev liberror-perl libexpat1-dev libfakeroot libfile-fcntllock-perl libflac8 libfontconfig1-dev libfreetype6-dev libfribidi-dev libgcc-5-dev libgcrypt20-dev libgdbm3 libgeoip1 libgl1-mesa-dev libglew-dev libglu1-mesa libglu1-mesa-dev libgmpv4-dev libgmpxxv4-4 libgnutls-dev libgnutls-openssl27 libgnutls28-dev  libgnutlsxx28 libgpg-error-dev libharfbuzz-dev libharfbuzz-gobject0 libharfbuzz-icu0 libicu-dev libidn11-dev libisc160 libisl15 libiso9660-8 libiso9660-dev libitm1 libjasper-dev libjasper1 libjbig-dev libjpeg-dev libjpeg-turbo8-dev libjpeg8-dev libjson-c2 libjsoncpp1 liblcms2-2 liblsan0 libltdl-dev libltdl7 liblzma-dev liblzo2-dev libmicrohttpd-dev libmpc3 libmpeg2-4 libmpeg2-4-dev libmpfr4 libmpx0 libmysqlclient-dev libnfs-dev libnspr4 libnss3 libnss3-nssdb libogg-dev libp11-kit-dev libpcre16-3 libpcre3-dev libpcre32-3 libpcsclite1 libperl5.22 libpng12-dev libpostproc-dev libpthread-stubs0-dev libpulse0 libpython-dev libpython2.7-dev libquadmath0 libsctp1 libsigsegv2 libsmbclient-dev libsndfile1 libsqlite3-dev libssh-dev libssl-dev libssl-doc libstdc++-5-dev libswresample-dev libswscale-dev libtag1-dev libtasn1-6-dev libtasn1-doc libtiff5-dev libtiffxx5 libtinyxml-dev libtool libtsan0 libubsan0 libvorbis-dev libvorbisfile3 libwrap0 libx11-dev libx11-doc libx11-xcb-dev libxau-dev libxcb-dri2-0-dev libxcb-dri3-dev libxcb-glx0-dev libxcb-present-dev libxcb-randr0 libxcb-randr0-dev libxcb-render0 libxcb-render0-dev libxcb-shape0 libxcb-shape0-dev libxcb-sync-dev libxcb-xfixes0 libxcb-xfixes0-dev libxcb1-dev libxdamage-dev libxdmcp-dev libxext-dev libxfixes-dev libxml2-dev libxmuu1 libxrandr-dev libxrender-dev libxshmfence-dev libxslt1-dev libxtables11 libxxf86vm-dev libyajl-dev linux-libc-dev m4 make manpages manpages-dev mesa-common-dev netbase nettle-dev openjdk-8-jre-headless openssh-client openssl patch perl perl-modules-5.22 pkg-config python-dev python2.7-dev rename rsync swig swig3.0 tcpd unzip uuid-dev x11proto-core-dev x11proto-damage-dev x11proto-dri2-dev x11proto-fixes-dev x11proto-gl-dev x11proto-input-dev x11proto-kb-dev x11proto-randr-dev x11proto-render-dev x11proto-xext-dev x11proto-xf86vidmode-dev xauth xorg-sgml-doctools xtrans-dev xz-utils zip zlib1g-dev && \
		apt-get clean && \
